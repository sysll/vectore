...
class ResNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.layer2 = self._make_layer(64, 128, 2, stride=5)
        self.layer3 = self._make_layer(128, 256, 2)
        self.layer4 = self._make_layer(256, 512, 2)
        self.layer5 = self._make_layer(512, 64, 2)
...
# model = torch.load("kk.pt")
# model.eval()
# # # # # # #残差的解
# # """这个测试是在resnet对象存在的情况下进行的"""
# all_test_target = []
# all_test_output = []
# m = 0
# for inputs, labels in dataloaders['val']:
...
#         return output
# cnn = CNNModel(3200, 2, 50).to(device)
# # 定义损失函数和优化器
# criterion = nn.MSELoss()
